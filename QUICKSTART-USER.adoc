...
// Replace kea, Kea — See README.adoc for details., just run, Kea started successfully. with actuals
= kea — Quick Start for Users
:toc:
:toclevels: 2

== What is kea?

Kea — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./kea-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/kea/wiki
